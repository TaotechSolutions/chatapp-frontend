...
function ChatBubble({message, isSender}) {
    ...
    const bubbleClass = `p-4 rounded  ${isSender ? "bg-blue-600 text-white" : "bg-gray-100 text-black"}`
  ...
  return (
    <>
      ...
      <div className = {contClass}>
        {!isSender && 
        (<img src = {message.profilepic} alt = "profile-pic" className = "rounded-full mr-2" 
